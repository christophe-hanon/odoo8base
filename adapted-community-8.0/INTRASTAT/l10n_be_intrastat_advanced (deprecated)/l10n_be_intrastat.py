...
class L10nBeReportIntrastatProduct(models.Model):
    _name = 'l10n.be.report.intrastat.product'
    _description = "Intrastat Product for Belgium"
    _rec_name = 'year_month'
    _inherit = ['mail.thread', 'report.intrastat.common']
    _order = 'year_month desc, type, revision'
    _track = {
        'state': {
            'l10n_be_intrastat_advanced.l10n_be_declaration_done':
    ...
    intrastat_line_ids = fields.One2many(
        'l10n.be.report.intrastat.product.line',
    ...
    def generate_xml(self):
        """ generate XML for ONEGATE declaration """
        self.ensure_one()
        WIP


class L10nBeReportIntrastatProductLine(models.Model):
    _name = 'l10n.be.report.intrastat.product.line'
    _description = "Intrastat Product Lines"

    parent_id = fields.Many2one(
        'l10n.be.report.intrastat.product',
    ...
    intrastat_unit_id = fields.Many2one(
        'intrastat.unit', related='intrastat_code_id.intrastat_unit_id',
        string='Suppl. Unit',
