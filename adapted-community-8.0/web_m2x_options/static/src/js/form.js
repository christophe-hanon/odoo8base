...
openerp.web_m2x_options = function (instance) {
	...
	get_options: function() {
	    var self = this;
	    if (this.options.ir_options_loaded === 'undefined' && _.isUndefined(this.view.ir_options_loaded)) {
     ...
     show_error_displayer: function () {
        ...
        get_search_result: function (search_val) {
            ...
            // returned.
    	    if ('ir_options' in this.view && 'web_m2x_options.limit' in this.view.ir_options && !_.isUndefined(this.view.ir_options['web_m2x_options.limit'])) {
            ...
            $.when(search_result, create_rights).then(function (data, can_create) {
                ...
                if (('create' in self.options && _.isUndefined(self.options.create) && _.isUndefined(self.view.ir_options['web_m2x_options.create']) && can_create) || 
            ('create' in self.options && _.isUndefined(self.options.create) && self.view.ir_options['web_m2x_options.create'] == "True") ||
                    self.options.create) {
                ...
                if (('create_edit' in self.options && _.isUndefined(self.options.create_edit) && _.isUndefined(self.view.ir_options['web_m2x_options.create_edit']) && can_create) ||
		    ('create_edit' in self.options && _.isUndefined(self.options.create) && self.view.ir_options['web_m2x_options.create_edit'] == "True") ||
	...
	get_options: function() {
	    var self = this;
	    if (this.view != undefined && _.isUndefined(this.view.ir_options_loaded)) {
		    this.view.ir_options_loaded = $.Deferred();
		    this.view.ir_options = {};
		    (new instance.web.Model("ir.config_parameter"))
	                .query(["key", "value"]).filter([['key', 'in', OPTIONS]])
	    ...
	    return this.view != undefined && this.view.ir_options_loaded;
	},
        ...
        */
	    ...
	    if (this.view != undefined && !_.isUndefined(this.view.ir_options['web_m2x_options.limit'])) {
	        this.limit = parseInt(this.view.ir_options['web_m2x_options.limit']);
	    }
            ...
            return this.orderer.add(dataset.name_search(
                ...
                if ((_.isUndefined(self.options.create) && self.view != undefined && _.isUndefined(self.view.ir_options['web_m2x_options.create'])) ||
		    (_.isUndefined(self.options.create) && self.view != undefined && self.view.ir_options['web_m2x_options.create'] == 'True') ||
                    self.options.create) {
	            ...
	            (_.isUndefined(self.options.create) && self.view != undefined && self.view.ir_options['web_m2x_options.create_edit'] == 'True') ||
                    self.options.create_edit) {
