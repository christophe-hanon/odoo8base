...
if __name__=='__main__':
    ...
    lang = 'fr'
    print 70, ">>", amount_to_text(70, lang)
    print 71, ">>", amount_to_text(71, lang)
    print 80, ">>", amount_to_text(80, lang)
    print 81, ">>", amount_to_text(81, lang)
    print 100, ">>", amount_to_text(100, lang)
    print 200, ">>", amount_to_text(200, lang)
    
    print 1000, ">>", amount_to_text(1000, lang)
    print 2000, ">>", amount_to_text(2000, lang)
    print 2345, ">>", amount_to_text(2345, lang)
